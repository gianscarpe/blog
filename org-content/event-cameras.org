...
* Event-cameras                                                
** TODO A gentle introduction to event cameras                :introduction:event_cameras:
:PROPERTIES:
...
#+attr_html: :width 200 :float right :title This is me saying \"hello\"
#+ATTR_ORG: :width 100
[[file:images/me.png]]
...
follows. I present [[/introduction#event-cameras][event-cameras]], their principle of operations, and their
motivation. Next, I show some [[/introduction#solutions][solutions]] to solve the main challenges of
event-based vision. And finally, I summarize our [[/introduction#conclusion][conclusions]] and propose our
...
on) are captured. Major competitors [fn:: Samsung
...
:PROPERTIES:
:EXPORT_FILE_NAME: event_based_monocular_human_pose_estiamtion
