...
#+attr_html: :class center :float right :title Old joke (link https://xkcd.com/1425/)
#+ATTR_ORG: :width 10
...
blooming.
#+attr_html: :class center :float right :title Dash Cameras vs Event-cameras (provided by Prophesee)
#+ATTR_ORG: :width 100
...
flexible.
#TODO: add video comparison events/standard cameras
...
#+attr_html: :class center :float right :title How does it work?
#+ATTR_ORG: :width 10
[[file:images/sphere_comparison.png]]
